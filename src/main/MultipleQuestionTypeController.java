 ...
 * @author almin
 */
public class MultipleQuestionTypeController implements Initializable {
    ...
    public void setApp(Main application) {
        ...
        lstAnswers.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
    ...
    private void processNextQuestion(ActionEvent event) throws Exception {
        ObservableList<Answer> selectedAnswers = lstAnswers.getSelectionModel().getSelectedItems();
